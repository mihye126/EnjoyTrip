...
<html lang="en">
<head>
  <title>Pixel Pro - 404 Not Found</title>
  <meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no">
  <meta name="title" content="Pixel Pro - 404 Not Found">
  ...
  <meta property="og:title" content="Pixel Pro - 404 Not Found">
  ...
  <meta property="twitter:title" content="Pixel Pro - 404 Not Found">
  ...
  <link type="text/css" href="../../vendor/@fortawesome/fontawesome-free/css/all.min.css"
        rel="stylesheet">
      ...
      <div class="row">
        <div class="col-12 text-center text-dark d-flex align-items-center justify-content-center">
          <div><a href="./../index.html"><img class="img-fluid w-50"
            ...
            <p class="lead my-4 px-lg-11">Oops! Looks like you followed a bad link. If you think
              this is a problem with us, please tell us.</p><a class="btn btn-primary animate-hover"
                                                               href="../../index.html"><span
                class="fas fa-chevron-left me-3 ps-2 animate-left-3"></span>Go back home</a></div>
        </div>
      </div>
    </div>
  </section>
...
<script defer
        ...
        data-cf-beacon='{"rayId":"7ae4585cad6083c0","version":"2023.3.0","r":1,"token":"3a2c60bab7654724a0f7e5946db4ea5a","si":100}'
